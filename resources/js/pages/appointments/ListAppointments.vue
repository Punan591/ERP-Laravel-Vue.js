                    ...
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <div class="btn-group">
                            <button @click="getAppointments()" type="button" class="btn"
                                ...
                                <span class="badge badge-pill badge-info" style="background-color:#333333!important;">{{ appointmentsCount }}</span>
                            </button>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr v-for="(appointment, index) in appointments.data" :key="appointment.id">
                                        ...
                                        <td>
                                            <span class="badge" :class="`badge-${appointment.status.color}`"  style="background-color: #ffc107;">{{
